...
# test tasks 
tasks=(
    meat_off_grill put_groceries_in_cupboard
)
...
headless=1 # NEW – attempt render headless
...
for ((i=0; i<$num_ckpts; i++)); do
    CUDA_LAUNCH_BLOCKING=1 DISPLAY=:99 python -m online_evaluation_rlbench.evaluate_policy \
    --tasks ${tasks[$i]} \
